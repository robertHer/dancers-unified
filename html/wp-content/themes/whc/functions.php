...
function whc_scripts() {
	...
	wp_enqueue_style( 'custom-style', get_template_directory_uri() .'css/app.css', array() , '1.0.0', 'all' );
...
function whc_custom_post_type(){
	...
	register_post_type('posts3', $post3Args);
	register_post_type('posts4', $post4Args);
	register_post_type('posts5', $post5Args);
	register_post_type('posts6', $post6Args);
	register_post_type('posts7', $post7Args);
